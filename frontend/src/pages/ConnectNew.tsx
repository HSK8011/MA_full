...
import ConnectNewContent from '../components/organisms/Connect/ConnectNewContent';

const ConnectNew: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Set page title
    document.title = 'Connect New Channel - Marketing Automation Tools';
    setIsLoading(false);
  }, []);
